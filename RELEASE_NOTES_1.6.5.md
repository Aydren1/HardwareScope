...
HardwareScope 1.6.5 adds a horizontal layout for the on-screen display.
...
- Self-contained Windows x64 installer; no separate .NET installation is required.
- Includes the PawnIO sensor driver installer for supported low-level sensors.

HardwareScope 1.6.5 is currently unsigned, so Windows SmartScreen may show an unknown-publisher warning.
